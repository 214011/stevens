        ...
        <main class="main">
            <article class="blog content-w">
                ...
                <figure class="blog__image">
                    <img src="images/blog_arisue.jpg" alt="バリカンのイメージ画像" width="2239" height="2560">
                </figure>
            ...
            <div class="blog__pager content-w">
                <button class="blog__pager--previousBtn __blog-arrowBtn" type="button"
                    onclick="location.href='blog-content_01.php'"><span class="fa-sr-only">前の記事へ</span></button>
                <ul class="blog__pager--link">
                    <li class="blog__pager--link_item"><a href="blog-content_01.php">1</a></li>
                    <li class="blog__pager--link_item"><a href="blog-content_02.php" class="__blog-current">2</a></li>
                ...
                <button class="blog__pager--nextBtn" type="button" onclick="location.href='blog-content_03.php'"><span
