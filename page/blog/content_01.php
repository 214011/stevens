        ...
        <main class="main">
            <article class="blog content-w">
                ...
                <figure class="blog__image">
                    <img src="images/blog-kubata.jpg" alt="天然水" width="680" height="454">
                </figure>
            ...
            <div class="blog__pager content-w">
                ...
                <ul class="blog__pager--link">
                    <li class="blog__pager--link_item"><a href="blog-content_01.php" class="__blog-current">1</a></li>
                ...
                <button class="blog__pager--nextBtn" type="button" onclick="location.href='blog-content_02.php'"><span
