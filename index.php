                ...
                <div class="index__container--catchcopy">
                    <div class="content-w">
                        <h2 class="catchcopy--text">
                            <span class="catchcopy--text__Stylish"><img src="images/index_Stylish.svg" alt="Stylish" width="453" height="92"></span>
                            <span class="catchcopy--text__and"><img src="images/index_and.svg" alt="and" width="193" height="46"></span>
                            <span class="catchcopy--text__Beauty"><img src="images/index_Beauty.svg" alt="Beauty" width="426" height="89"></span>
                        </h2>
                    </div>
                </div>
            </section>
                ...
                <div class="index__container--content __contact-content">
                    <div class="content__area">
                        <div class="content__inner">
                            ...
                            <p class="btn__outer"><a class="btn" href="contact.php">お問い合わせページへ</a></p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="index__container--content __account-content">
                    <div class="content__area">
                        <div class="content__inner">
                            ...
                            <p class="btn__outer"><a class="btn" href="account.php">アカウント登録する</a></p>
                        </div>
                    </div>
                </div>
            </section>
